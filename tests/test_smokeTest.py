...
class TestTestsmokeTest2():
  ...
  def test_homepage(self):
    self.driver.get("https://carsonpenn.github.io/cse270-teton/join.html")
    self.driver.set_window_size(1154, 1048)
  ...
  def test_join(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Coleman")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Trebor")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("Jedi Order")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Jedi Master")
    self.driver.find_element(By.NAME, "submit").click()
    self.driver.find_element(By.NAME, "email").click()
    elements = self.driver.find_elements(By.NAME, "email")
    assert len(elements) > 0
  
  def test_spotlightjoinlink(self):
    self.driver.get("https://carsonpenn.github.io/cse270-teton/index.html")
    self.driver.set_window_size(1154, 1048)
